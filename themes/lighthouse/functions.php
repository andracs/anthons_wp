...
function lighthouse_info_styles( $hook ) {
    if ( 'appearance_page_lighthouse-infopage' !== $hook ) {
        return;
    }
    wp_enqueue_style( 'lighthouse-info-styles', get_template_directory_uri() . '/css/admin.css', false, '3.0' );
}
add_action( 'admin_enqueue_scripts', 'lighthouse_info_styles' );

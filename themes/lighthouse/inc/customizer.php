...
function lighthouse_customize_register( $wp_customize ) {
 ...
 $wp_customize->remove_control('display_header_text');
	...
	$wp_customize->add_setting('lighthouse_rating_tabsection', array(
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'rating_tab', array(
		...
		'settings' => 'lighthouse_rating_tabsection',
		'type' => 'none',
		'priority' => 105
		) )
	);   
	...
	$wp_customize->add_setting('lighthouse_contact_today_tabs', array(
		'sanitize_callback' => 'unneeded',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	);
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'contact_today_tab', array(
		'section' => 'lighthouse_contact_today',
		'settings' => 'lighthouse_contact_today_tabs',
		'type' => 'none',
		'priority' => 105
		) )
	);   
	...
	$wp_customize->add_setting('lighthouse_feature_tabs', array(
		'sanitize_callback' => 'unneeded',
		'type' => 'info_control',
		'capability' => 'edit_theme_options',
		)
	);
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'feature_tab_sec', array(
		'section' => 'lighthouse_features_tabs',
		'settings' => 'lighthouse_feature_tabs',
		'type' => 'none',
		'priority' => 109
		) )
	);   
...
if(! function_exists('lighthouse_backendfunctions' ) ):
function lighthouse_backendfunctions(){
	...
	<?php }
	add_action( 'wp_head', 'lighthouse_backendfunctions' );
	endif;
